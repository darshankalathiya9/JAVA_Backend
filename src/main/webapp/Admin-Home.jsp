...
<div id="wrapper">
     <!-- Navigation -->
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <% List<Seller> list = SellerDao.getAllSellers(); %>
                      ...
                      <a href="Admin-Seller-List.jsp"><span>Sellers</span></a>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <% List<Customer> list1 = CustomerDao.getAllCustomers(); %>
                      <h5><strong><%out.print(list1.size()); %></strong></h5>
					  <a href="Admin-Customer-List.jsp"><span>Customers</span></a>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <% List<Product> list2 = ProductDao.getAllProduct(); %>
					  ...
					  <a href="Admin-Product-List.jsp"><span>Products</span></a>	
                    </div>
                </div>
        	 </div>
		...
		<div class="copy">
            <p> &copy; 2023 Bootie Ecommerce | All Rights Reserved | Design by DK </p>
	    </div>
		</div>
       </div>
      <!-- /#page-wrapper -->
